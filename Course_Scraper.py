...
def get_reqs_and_final(course_page):
    ...
    for entry in tr_container:
        ...
        if paren_flag:
            ...
            if "Yes" in td_container[3]:
                course_coreqs.append(course_title)
            else:
                course_reqs.append(course_title)
...
def load_courses():
    ...
    # "97 - Variable Topics in Computer Science: Launch: Turn Idea into Company",
    # "111 - Operating Systems Principles",
    # "118 - Computer Network Fundamentals",
    # "C121 - Probabilistic Models in Computational Genomics",
    # "130 - Software Engineering",
    # "180 - Introduction to Algorithms and Complexity",
    # "181 - Theory of Computing",
